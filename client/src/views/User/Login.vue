  ...
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-form-item prop="username">
        <template #label><i class="el-icon-user" /> 学号</template>
      ...
      <el-form-item prop="password">
        ...
        <el-input v-model="loginForm.password" type="password" auto-complete="off" placeholder="请输入密码（初始密码为身份证号，X需大写）"></el-input>
      </el-form-item>
      ...
      <div style="text-align: right">
        <el-button type="text" @click="$router.push('/loginDepart')" style="font-size: 14px;">用工部门登录</el-button>
      </div>
    </el-form>
    <!--  底部  -->

  ...
  <el-container>
    ...
    <el-container>
      ...
      <el-header :style="{ marginLeft: mainLeft, width: 'calc(100% - ' + asideWidth + ')' }">
        <i class="el-icon-arrow-left" style="font-size: 20px;font-weight: bolder;padding-right: 5px" @click="$router.go(-1)"></i>
        ...
        <div style="flex: 1;display: flex;justify-content: flex-end;">
          <el-dropdown placement="bottom">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click.native="$router.push('/Phone/mhome')">主页</el-dropdown-item>
              <el-dropdown-item @click.native="$router.push('/Phone/inform')">个人信息</el-dropdown-item>
              <el-dropdown-item @click.native="$router.push('/Phone/PassChange')">修改密码</el-dropdown-item>
              <el-dropdown-item @click.native="logout()" style="color: red">退出登录</el-dropdown-item>
              <el-dropdown-item @click.native="$router.push('/')">返回电脑板</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div>
      </el-header>
      <!--主体-->
      <el-main v-loading="loading" style="margin-top: 60px">
